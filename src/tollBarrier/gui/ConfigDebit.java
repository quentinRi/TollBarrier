	...
	private void initGUI() {
		try {
			...
			}
			{
				ComboBoxModel jComboBox1Model = 
						new DefaultComboBoxModel(
								new String[] {"Voiture", "Camion", "Moto" });
			...
			thisLayout.setVerticalGroup(thisLayout.createSequentialGroup()
				...
				.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
				.addComponent(jRadioButton4, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE)
				.addGap(15)
			...
			thisLayout.setHorizontalGroup(thisLayout.createSequentialGroup()
				...
				.addGroup(thisLayout.createParallelGroup()
				    ...
				    .addGroup(GroupLayout.Alignment.LEADING, thisLayout.createSequentialGroup()
				        ...
				        .addGap(13))
				    .addComponent(jRadioButton1, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 122, GroupLayout.PREFERRED_SIZE)
				    .addComponent(jRadioButton2, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 122, GroupLayout.PREFERRED_SIZE)
				    .addComponent(jRadioButton3, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 122, GroupLayout.PREFERRED_SIZE)
				    .addComponent(jRadioButton4, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 122, GroupLayout.PREFERRED_SIZE))
